---
description: name: paul description: Plan-Apply-Unify Loop (PAUL) structured AI development framework. Use when user invokes /paul commands (/paul:init, /paul:plan, /paul:apply, /paul:unify, /paul:status, /paul:help, etc.) or requests PAUL workflow execution.
---

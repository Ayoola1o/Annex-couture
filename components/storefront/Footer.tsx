    ...
    <footer className="bg-noir-950 border-t border-gold-600/20 text-neutral-400 font-sans pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-gold-600/15">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-flex items-center gap-3 group">
              ...
              />
              <div>
                <span className="font-serif text-xl tracking-[0.2em] text-neutral-100 font-light block leading-none">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="/about" className="hover:text-gold-300 transition-colors">About Atelier & Founder</Link></li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          <p>© {new Date().getFullYear()} {settings.companyName || 'Annex Couture'}. All rights reserved. Crafted for Vercel deployment.</p>
